...
//      - [X] LOAD ARTICLES FROM SELECTED LIST
// 
...
function addStories(storyList){
    ...
    storyList.forEach(storyOBJ =>{
        ...
        // titleAnchor.setAttribute('class','title');
        ...
        articleTextBlock.appendChild(titleElement);
        ...
        const pubDateSpan = document.createElement('div');
        pubDateSpan.setAttribute('class','pubDate');
